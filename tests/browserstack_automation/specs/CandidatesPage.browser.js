...
describe('Candidates PageBrowser', () => {
  // Candidates_001
  ...
  it('verifyCandidateNameClick @WV-1073', async () => {
    ...
    driver.waitUntil(async () => (browser.getUrl()).contains(nameFirst), { timeput: 4000, timeoutMsg: 'Candidate PageBrowser not opened within exected duration.' });
